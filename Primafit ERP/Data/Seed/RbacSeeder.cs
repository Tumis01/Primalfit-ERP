...
namespace Primafit_ERP.Data.Seed
{
    public static class RbacSeeder
    {
        public static async Task SeedAsync(AppDbContext context, RoleManager<ApplicationRole> roleManager)
        {
            ...
            {
                // Access to the Segment Setup Page
                ...
                // Access to the Chart of Accounts Page
                ...
                // Access to the Bank Reconciliation Page
                ...
                // Access to the Budget Management Page
                ...
                new() { Module = "REPORTS", PageKey = "REPORTS_PAGE", ActionKey = null, DisplayName = "Access Reports", Category = "Reporting" },
                ...
                new() { Module = "MASTER_DATA", PageKey = "MD_CUSTOMER_GROUPS_PAGE", ActionKey = "CUSTOMER_GROUP_MANAGE", DisplayName = "Create/Edit and delete Customer Groups", Category = "Operations" },
                ...
                new() { Module = "SALES", PageKey = "SALES_ORDER_PAGE", ActionKey = "SALES_ORDER_CREATE", DisplayName = "Create/Edit Quotes, invoices & Orders", Category = "Operations" },
            ...
            {
                new() { RoleName = "CFO", Description = "Chief Financial Officer - Full Financial Access", IsSystem = true },
                new() { RoleName = "Accountant", Description = "Standard Finance Operations", IsSystem = true },
                new() { RoleName = "Clerk", Description = "Data Entry (No Posting Rights)", IsSystem = true },
            ...
            // CFO - Full Access across Finance, Operations, and Reporting
            Grant("CFO",
                  "GL_PAGE", "GL_JOURNAL_CREATE", "GL_BATCH_APPROVE", "GL_BATCH_POST", "GL_PERIOD_CLOSE",
                  "GL_SEGMENT_SETUP_PAGE", "GL_SEGMENT_CONFIG", "GL_SEGMENT_MANAGE_VALUES",
                  "GL_COA_PAGE", "GL_COA_MANAGE", "GL_COA_IMPORT_EXPORT",
                  "CASHBOOK_PAGE", "CASHBOOK_BATCH_CREATE", "CASHBOOK_BATCH_APPROVE", "CASHBOOK_BATCH_POST",
                  "RECON_PAGE", "RECON_START", "RECON_MATCH", "RECON_FINALIZE",
                  "BUDGET_PAGE", "BUDGET_MANAGE", "BUDGET_IMPORT_EXPORT",
                  "FINANCE_REPORTS_PAGE", "SALES_REPORTS_PAGE", "REPORTS_PAGE",
                  "MD_CUSTOMER_GROUPS_PAGE", "CUSTOMER_GROUP_MANAGE", "CUSTOMER_DELETE",
                  "SALES_ORDER_PAGE", "SALES_ORDER_CREATE", "SALES_INVOICE_CREATE", "SALES_INVOICE_POST", "SALES_ORDER_DELETE",
                  "AR_PAYMENT_PAGE", "AR_PAYMENT_CREATE",
                  "CREDIT_NOTE_PAGE", "CREDIT_NOTE_CREATE", "CREDIT_NOTE_DELETE", "CREDIT_NOTE_POST",
                  "WH_SHIPMENTS_PAGE", "SHIPMENT_CREATE", "SHIPMENT_DISPATCH",
                  "PURCHASING_PAGE", "PO_CREATE", "PO_APPROVE", "PO_DELETE", "PO_INVOICE_POST");
